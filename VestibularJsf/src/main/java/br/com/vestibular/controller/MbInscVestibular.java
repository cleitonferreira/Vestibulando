 ...
 * @author cleiton
 */
@ManagedBean(name = "mbInscVestibular")
@ViewScoped
public class MbInscVestibular implements Serializable {
    ...
    public MbInscVestibular() {
    }

    @PostConstruct
    public void init() {
        vestibulares = dao.consultaTodosVestibulares();
        cursos = dao.consultaTodosCursos("vestibular");
...
//        System.out.println("Busca Cidade>>>>>>>>>>>>");
    ...
    public String editInscricao() {
        return "/restrict/cadastros/vestibular.faces";
    }
